...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # 04/02/2024: * in Regexp would fail to match when there is no string... but if there is a string
    #   pattern of even nothing "" that would still count as that means 0 occurences. And * means
    #   anything as a wildcard. So it doesn't fail.
  end
  ...
  #
  # Why?
  #   04/04/2024: By "greedy", this implies the most amount of some quantity or volume.
  #     By this logic, this means it will look for the string match with the longest
  #     match that satisfies the pattern.
  ...
  #   04/04/2024: The difference between  character class and alternation is that 
  #     a character class takes into account any combinations of SINGLE characters,
  #     while alternation allow combinations of MULTIPLE characters.
