...
class AboutSymbols < Neo::Koan
  ...
  #   My answer 03/24/2024: Possible that when trying to create :test_method_names_become_symbols,
  #     generates a new .object_id to go with it because the symbol implicitly already exists
  #   Stackoverflow: https://stackoverflow.com/questions/4686097/ruby-koans-why-convert-list-of-symbols-to-strings
